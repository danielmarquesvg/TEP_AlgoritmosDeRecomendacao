...
public class PanelGerarArquivoDePredicao extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelGerarArquivoDePredicao() {
		...
		JLabel labelGerarArquivoDePredicao = new JLabel("Gerar Arquivo de Predição de Teste");
		labelGerarArquivoDePredicao.setForeground(Color.WHITE);
		labelGerarArquivoDePredicao.setFont(new Font("Segoe UI Light", Font.PLAIN, 38));
		labelGerarArquivoDePredicao.setBounds(29, 459, 722, 51);
		add(labelGerarArquivoDePredicao);
